...
@Composable
fun CapitalDifficultyOptions(navController: NavController, capitalViewModel: CapitalViewModel){
    Box(modifier = Modifier.fillMaxSize()){
        ...
        Column(
            ...
            ElevatedButton(
                onClick = {
                    capitalViewModel.setDifficulty("easy")
                    if (isModeWritten.value){
                        navController.navigate("capital_written_quiz")
                    }else{
            ...
            ElevatedButton(onClick = {
                capitalViewModel.setDifficulty("medium")
                if (isModeWritten.value){
                    navController.navigate("capital_written_quiz")
                }else{
                    navController.navigate("capitalquiz")
            ...
            ElevatedButton(onClick = {
                capitalViewModel.setDifficulty("hard")
                if (isModeWritten.value){
                    navController.navigate("capital_written_quiz")
                }else{
                    navController.navigate("capitalquiz")
            ...
            ElevatedButton(onClick = {
                capitalViewModel.setDifficulty("all")
                if (isModeWritten.value){
                    navController.navigate("capital_written_quiz")
                }else{
                    navController.navigate("capitalquiz")
